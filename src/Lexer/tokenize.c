...
void tokenize_content(const char *content, Token tokens[], int *count) {
    ...
    while (*p != '\0' && *count < 63) {
        ...
        if (*p == '"' || *p == '\'') {
            ...
            } else if (strcmp(tokens[*count].value, "card") == 0) {
            ...
            } else if (strcmp(tokens[*count].value, "convert") == 0) {
            ...
            } else if (strcmp(tokens[*count].value, "undo") == 0) {
                tokens[*count].type = TOKEN_UNDO;
